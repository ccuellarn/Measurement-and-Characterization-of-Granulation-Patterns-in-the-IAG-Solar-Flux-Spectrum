...
Taking the element described before, now suposse an elementary parcel of the material is displaced so slowly that remains in horizontal pressure equilibrium. 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{Granulation pattern.jpg}
    \caption{The image shows frame by frame the motion of few granules. Image taken from \cite{Foukal_1990}}
