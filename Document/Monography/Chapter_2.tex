...
\hfill
     \begin{subfigure}{0.48\textwidth}
         ...
         \caption{The outer structure of the Sun. The photosphere is the layer of the sun where is visible the convection cells overshooting from the convection zone.}
...
On the other hand, the figure \ref{sun outer atmosphere} shown the overall structure of the solar outer atmosphere which consist in photosphere, chromosphere and corona. 
...
\begin{figure}[H]
    ...
    \caption{The first clear photgraphy of the photosphere where is visible the granulation pattern. Image taken from \cite{Malherbe_2022}}
