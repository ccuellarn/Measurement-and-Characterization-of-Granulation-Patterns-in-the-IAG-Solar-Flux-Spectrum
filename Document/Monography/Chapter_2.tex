...
This section explores the different motion characteristics that made the Sun an interesting star for study and how the three signatures are dependent of the hydrodynamic in the photosphere. 
...
What makes this star really unique is his proximity to earth and the facility to study from the planet with precision \cite{Priest_1982}.
Since 1874 when Langley gives a detailed description of granulation on the photosphere \cite{Priest_1982}, the astronomers have been studied different motions and reactions across the layers. 
Furthermore, in 1885 when Janssen take the photgraphy of the granules in the photospere and lately, Plasketts relationed these granules with the Bernards laboratory measurements of fluids convection\cite{Foukal_1990} we start taking into account the dynamics of the layers in the Sun.

In general, the Sun is divided in two fundamental parts: The interior and the outer atmosphere. 

The overall structure of the interior is core, radiative and convective zone. 
Across then the density and temperature falls significantly. Models of its structure give a central temperature of $1.6\times 10^7 K$ and density to $1.6\times 10^5 Kg/m^3$, high enough for thermonuclear reactions and remains the central material in plasma like a gigantic atomic reactor. 
The core generates the 99 percent of the generates which is slowly transferred outwards by radiative diffusion.
This part of the Sun is so opaque cause there are so many collisions, absorptions and reemisions of photons.
The effect of this collisions is to increase the wavelength from high-energy gamma rays to visible ligth. 
The most important layer to this study is the convection zone. In this zone the temperature gradient is great for the material to stay in static equilibrium, and is where the magnetic field is generated\cite{Priest_1982}.

On the other hand, the outer atmosphere consist in photosphere, chromosphere and corona. 
In this part the density decreases rather rapidly with height above solar surface and the temperature decrease to $4300K$ and then rises through the transition region.
