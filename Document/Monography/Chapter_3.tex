...
Figure~\ref{fig:variance} shows that this parameter set performs well in the visible spectrum. 
...
\begin{figure}[H]
     ...
     \begin{subfigure}{1.0\textwidth}
         ...
         \caption{Variance for several lines in the visible range for the Solar Flux Atlas.}
...
\hfill
     \begin{subfigure}{1.0\textwidth}
         ...
         \caption{Variance for several lines in the near infrared range for the Solar Flux Atlas.}
...
Then, the same analysis was performed to the blueshift.
And we study the variance of the window of the polynomial fit.
\textcolor{Miku}{IN PROGRESS}
