...
\begin{figure}[H]
    \centering
 \includegraphics[width=0.85\linewidth]{Images/Results/Third signature/Velocity bins SPA.pdf}
    \caption{Individual plots of wavelength across line depth representing each bin of velocity in the visible range for the IAG spatially resolved quiet sun atlas. The value for slopes on this spectrum are higher than the disk-integrated flux atlas.}\label{fig:Velocity bins slopes SPA}
\end{figure}
...
In Figure~\ref{fig:coeff plot vel NIR} the natural H band follows the same behavior as the coefficients for the visible range with magnitude differences. Additionally, the visible range of the disk-spatially spectrum shows a more linear trend than the disk-center spectrum.
...
Third siganture velocity discusion: 
