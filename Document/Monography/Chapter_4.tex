Our results can be summarized in three principal aspects: Chromodependence on the granulation pattern along the line depth; a detailed view of the first and second signature; and higher-quality graphs with reduced scatter.
...
As shown in figure \ref{Sharpness} the chromodepence presented on the third signature plot is characteristic of weaker lines. This type of lines are known to represent the lower potential excitations.
...
The behavior of the plot is according to the C-curved shape of the line bisector affected by convection movement, and calculated following the equation \eqref{third derivate relation}.
