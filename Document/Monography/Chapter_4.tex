...
\begin{figure}[H]
    \centering
 \includegraphics[width=1.0\linewidth]{Images/Results/GranulationPattern_ALL.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{Images/Results/Standard curve gray.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{Images/Results/color curves.pdf}
    \caption{Different color curves fitted to a specific range on granulation pattern. The tendency on the curves is more pronounced in the violet and red range.}\label{fig:Curves Solar Flux}
\end{figure}

The tendency on the curves is more pronounced in the violet and near infrared range. 
This can be interpreted as the standard curve from Gray and Oostra is shifted and flattered along decreasing wavelengths.
Taking the curve for the range $4970-5700\mathring{A}$ for the starting point or standard curve different scaling coefficients wer calculated as shown the table~\ref{tab:color coefficients}.
...
\end{tabular}
\caption{Scaling factors to the new standard curve shown in the equation~\eqref{eq:new standard curve}.}\label{tab:color coefficients}
\end{table}

The equation~\eqref{eq:new standard curve} reports a new standard curve which coefficients depends on the color, and give the corresponding granulation pattern curve for each color range exposed on the table \ref{color coefficients}.
...
The near infrared range dont show the same tendency have a linear behavior.
...
owever, its performance degrades in the infrared, where the number of data points defining the line core is reduced compared to a typical line in the visible range.
