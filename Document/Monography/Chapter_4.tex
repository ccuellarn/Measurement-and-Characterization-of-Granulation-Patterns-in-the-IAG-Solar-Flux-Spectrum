...
As shown in the figure~\ref{fig:curvature NIR} for the near infrared range, is visible as a natural division for wavelengths in $11400 \mathring{A}$, which corresponds to telluric lines of absorption in the atmosphere. 
Plotting all ranges of the Solar Flux Atlas is visible a line depth-dependence along wavelength.

\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{Images/Results/Curvature_ALL.pdf}
    ...
    \label{fig:all curvature solar flux}
\end{figure}

Despite the line depth-dependence shifts along wavelength is clear a linear tendency on the visible part of the atlas (see figure~\ref{fig:all curvature solar flux}).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/Curvature_Slope_VIS.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/Curvature_SPA.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/Curvature_Slope_SPA.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/Velocity lower potential_ALL.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/Velocity bins energy plot_ALL.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/Velocity bins energy ALL.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/Velocity bins energy SPA.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/Bisector slope_VIS.pdf}
...
For a point of comparision, the same analysis was realized to the disk center spectra (see figure \ref{bisector SPA}).

\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/Bisector_SPA.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/Bisector slope_SPA.pdf}
    \caption{First order polynomial fit adjusted to the range $0.3-0.6F/F_c$ for the line bisector slopes.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/Flux deficit_6253.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/Flux deficit curve_6253.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/Standard curve gray.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\linewidth]{Images/Results/color curves.pdf}
...
\end{tabular}
\caption{Values for the second order polynomial fit coefficients shown in figure \ref{Curves Solar Flux}.}
\label{coeficients color curves}
\end{table}

Taking the curve for the range $4970-5700\mathring{A}$ for the starting point or "standard curve" different scaling coefficients wer calculated as shown the table \ref{color coefficients}.
...
Furthermore, the variance of the observed wavelength was analysed altering the number of points on the fourth order polynomial fit. 
The figure \ref{variance} shows that is a good parameters until takes the infrared, where the number of points for line core is reduced comparing to a random line in the viisble.
...
\hfill
     ...
     \end{subfigure}
        ...
        \caption{Variance of the observed wavelength altering the number of points on the fourth order polynomial fit}
        \label{variance}
\end{figure}

This can proof that we do a good job?...
